...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 720352605;
...
fn wire__crate__api__simple__get_address_impl(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse((move || {
                    Result::<_, ()>::Ok(crate::api::simple::get_address())
                })())
            }
        },
    )
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        1 => wire__crate__api__simple__get_address_impl(port, ptr, rust_vec_len, data_len),
